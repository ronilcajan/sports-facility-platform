                ...
                <table class="w-full text-left border-collapse text-xs">
                    <thead>
                        <tr class="border-b border-neutral-100 dark:border-neutral-800 text-neutral-400 font-semibold uppercase">
                            ...
                            <th class="py-3 px-3 text-right">Approve/Reject</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800">
                        ...
                        <tr v-if="bookings.data.length === 0">
                            <td colSpan="9" class="py-8 text-center text-xs text-neutral-400">No bookings recorded for assigned court.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
